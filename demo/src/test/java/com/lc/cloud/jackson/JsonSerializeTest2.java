...
public class JsonSerializeTest2 {
    ...
    public void testSerialize() throws IOException {
        ...
        objectMapper.setSerializerProvider(new UserSerializer());
     ...
     * 自定义序列化方法
     */
    private static class UserSerializer extends DefaultSerializerProvider {
